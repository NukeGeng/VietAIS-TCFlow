...
| M13 | Migration/cutover/self-host operations | PROPOSED | deterministic planner, resumable ledger, and typed Projects/AccessControl/Planning/TaskFlow/RepositoryIntelligence Marten apply are verified; full-context apply, pre/post reconciliation, isolated backup/restore, and rollback remain required |
