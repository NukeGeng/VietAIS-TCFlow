...
| Protected-branch integration | CONFIRMED (main) | PRs #94 and #95 passed all required checks; PRs #96–#98 synchronized the domain branches, and PRs #99–#103 synchronized the acceptance readback. Current `main` is `ffcaa597b559b6cf8e5a0ec933d18a53a57995e1`, and readback confirms all long-lived branch trees match it. |
