...
using IdentityConstants = VietAIS.TCFlow.Shared.Authorization.IdentityConstants;
...
internal sealed class IdentityDbInitializer(
    ...
    IOptions<BootstrapAdminOptions> bootstrapAdminSettings) : IDbInitializer
{
    ...
    private async Task SeedAdminUserAsync()
    {
            ...
            is not FshUser adminUser)
        {
            ...
            adminUser.PasswordHash = password.HashPassword(adminUser, bootstrapAdminSettings.Value.Password);
