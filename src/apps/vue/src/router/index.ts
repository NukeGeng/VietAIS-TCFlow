...
export function createAppRouter() {
  const router = createRouter({
    ...
    routes: [
      ...
      { path: '/projects/:projectId/analysis', name: 'analysis', component: AnalysisView },
      { path: '/projects/:projectId/impacts', name: 'impacts', component: ImpactGraphView },
      { path: '/projects/:projectId/features', name: 'features', component: FeaturesView },
      { path: '/projects/:projectId/tasks', name: 'tasks', component: TaskBoardView },
      {
        path: '/projects/:projectId/tasks/:taskId',
        name: 'task-detail',
        component: TaskDetailView,
      },
      { path: '/projects/:projectId/admin', name: 'project-admin', component: ProjectAdminView },
