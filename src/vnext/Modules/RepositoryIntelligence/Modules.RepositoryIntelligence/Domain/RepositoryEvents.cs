...
public sealed record ImpactRecorded(Guid AnalysisRunId, string ImpactKey, string ChangeKey, string AffectedArtifactKey, string Severity, string Reason, decimal Confidence, string ActorId, string CorrelationId, DateTimeOffset OccurredAtUtc);
